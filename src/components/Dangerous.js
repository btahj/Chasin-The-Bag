            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col-md-4">
                        ...
                        <div className="row">
                            <h2 className="police"> Police Officer </h2>
                        </div>
                        <div className="list info">
                            <ul className="list">
                                ...
                                <li className="list"> <strong>Description-</strong> <p className="discription">The duties of a police officer, also known as a law enforcement officer, focus on protecting people and property. They patrol the areas they are assigned, <span id="more">...</span>{this.state.police && <span id="more"> which sometimes include entire jurisdictions, respond to calls, enforce laws, make arrests, issue citations, and occasionally testify in court cases.</span>}</p> </li>
                                <button onClick={() => this.myFunction()} id="myBtn" className="btn-sm btn-primary">Read more</button>
                                <li className="links-li">
                                    <a className="links" href="https://www.criminaljusticeusa.com/police-officer/" target="_blank" rel="noopener noreferrer"><strong>Links</strong></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div className="col-md-4">
                        ...
                        <div className="list info">
                            <ul className="list">
                                ...
                                <li className="list"> <strong>Description-</strong> <p className="discription">Firefighters are primarily responsible for responding to fires, accidents and other incidents where risks are posed to life and property. <span id="more2">...</span>{this.state.firefighter && <span id="more">  Firefighters work on a variety of emergencies, from chemical spills to water rescue.</span>}</p></li>
                                <button onClick={() => this.myFunction2()} id="myBtn" className="btn-sm btn-primary">Read more</button>
                                <li className="links-li">
                                    <a className="links" href="https://work.chron.com/education-need-firefighter-14733.html" target="_blank" rel="noopener noreferrer"><strong>Links</strong></a>
                                </li>
                            </ul>
                        </div>
                    </div>

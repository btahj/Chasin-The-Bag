                            ...
                            <ul className="list info">
                                ...
                                <li className="list"> <strong>Description-</strong>
                                    <p className="discription">
                                        The Constitution assigns the president two roles: chief executive of the federal government and Commander in<span id="more1">...</span>
                                        {this.state.show &&
                                ...
                                <li className="links-li">
                                    <a className="links" href="https://www.bls.gov/ooh/life-physical-and-social-science/political-scientists.htm" target="_blank" rel="noopener noreferrer"><strong>Links</strong></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div className="col-md-4">
                        ...
                        <div className="list">
                            <ul className="list info">
                                ...
                                <li className="links-li">
                                    <a className="links" href="https://www.thebalancecareers.com/doctor-career-information-526008" target="_blank" rel="noopener noreferrer"><strong>Links</strong></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div className="col-md-4">
                        ...
                        <div className="list">
                            <ul className="list info">
                                ...
                                <li className="links-li">
                                    <a className="links" href="https://www.entrepreneur.com/article/306578" target="_blank" rel="noopener noreferrer"><strong>Links</strong></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div className="col-md-4">
                            ...
                            <div className="list">
                                <ul className="list info">
                                    ...
                                    <li className="links-li">
                                        <a className="links" href="https://collegegrad.com/careers/lawyers" target="_blank" rel="noopener noreferrer"><strong>Links</strong></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div className="col-md-4">
                            ...
                            <div className="list">
                                <ul className="list info">
                                    ...
                                    <li className="links-li">
                                        <a className="links" href="https://www.thebalancecareers.com/what-does-a-sales-representative-do-526065" target="_blank" rel="noopener noreferrer"><strong>Links</strong></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div className="row">
                                ...
                                <div className="list">
                                    <ul className="list info">
                                        ...
                                        <li className="links-li">
                                            <a className="links" href="https://www.thebalancecareers.com/should-you-become-a-professional-athlete-525985" target="_blank" rel="noopener noreferrer"><strong>Links</strong></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div className="col-md-4">
                            ...
                            <div className="list">
                                <ul className="list info">
                                    ...
                                    <li className="links-li">
                                        <a className="links" href="https://www.thebalancecareers.com/cia-careers-525616" target="_blank" rel="noopener noreferrer"><strong>Links</strong></a>
                                    </li>
                                </ul>
                            </div>
                        </div>

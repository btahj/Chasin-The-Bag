                    ...
                    <div className="col-md-4">
                        ...
                        <div className="list info">
                            <ul className="list">
                                ...
                                <li className="list"> <strong>Longevity-</strong> 5 years is the Average a general programmer will stay programming video games.</li>
                                <li className="links-li">
                                    <a className="links" href="https://study.com/articles/Game_Developer_Job_Description_Duties_and_Requirements.html" target="_blank" rel="noopener noreferrer"><strong>Links</strong></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="col-md-4">
                        ...
                        <div className="list info">
                            <ul className="list">
                                ...
                                <li className="links-li">
                                    <a className="links" href="https://djbooth.net/features/2018-12-18-best-hip-hop-producers-2018" target="_blank" rel="noopener noreferrer"><strong>Links</strong></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div className="col-md-4">
                        ...
                        <div className="list info">
                            <ul className="list">
                                ...
                                <li className="list"> <strong>Description-</strong> <p className="discription">An astronaut typically boards a spaceship to fly on important missions for a specific purpose. As part of the crew, they have different assigned responsibilities to uphold as they aboard the spacecraft.  <span id="more4">...</span>{this.state.astro && <span id="more">An astronaut has various key roles to play which includes being a mission specialist to a commander. Those who have acquired years of experience and impressive background are the ones given more responsibilities to fulfill. Astronauts are also responsible to keep the safety of the whole crew and spacecraft. What they often do when they reach their destination is to observe the environment, take some essential samples from the place or bringing something back there.</span>}</p>
                                    <button onClick={() => this.myFunction4()} id="myBtn" className="btn-sm btn-primary">Read more</button></li>
                                <li className="links-li">
                                    <a className="links" href="https://www.bestjobdescriptions.com/science-and-technology/astronaut-job-description" target="_blank" rel="noopener noreferrer"><strong>Links</strong></a>
                                </li>
                            </ul>
                        </div>
                    </div>

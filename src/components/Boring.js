                        ...
                        <div className="row">
                            ...
                            <div className="list">
                                <ul className="list info">
                                    ...
                                    <li className="links-li">
                                        <a className="links" href="https://www.allbusinessschools.com/accounting/job-description/" target="_blank" rel="noopener noreferrer"><strong>Links</strong></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className="col-md-4">
                        ...
                        <div className="list">
                            <ul className="list info">
                                ...
                                <li className="links-li">
                                    <a className="links" href="https://www.thebalancecareers.com/public-relations-specialist-career-information-524873" target="_blank" rel="noopener noreferrer"><strong>Links</strong></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div className="col-md-4">
                        ...
                        <div className="list">
                            <ul className="list info">
                                ...
                                <li className="links-li">
                                    <a className="links" href="https://www.indeed.com/q-Secretary-l-California-jobs.html" target="_blank" rel="noopener noreferrer"><strong>Links</strong></a>
                                </li>
                            </ul>
                        </div>
                    </div>
